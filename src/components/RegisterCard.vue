  ...
  methods: {
    ...
    makeRegister(){
      ...
      if(this.state.email !='' && this.state.full_name != '' && this.state.password != ''){
          this.$http.post('/users/create',this.state).then(res=>{
            console.log(res)
              if(res.data.status_code == 400 && res.data.detail=='User with this email already exists.'){
             this.alertVisible = true;
                this.typeAlert = 'warning';      
                this.msgalert = 'Email ja em utilização';
            
              }else if(res.status ==200){
               this.alertVisible = true;
              this.typeAlert = 'success';      
              this.msgalert = 'Usuario criado com sucesso';
              }else{
                this.alertVisible = true;
                this.typeAlert = 'error';      
                this.msgalert = 'Erro ao criar usuario';
              }
         ...
         this.alertVisible = true;
         this.typeAlert = 'warning';      
         this.msgalert = 'Preencha todos os campos';
      }
